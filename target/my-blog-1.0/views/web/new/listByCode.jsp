...
<section class="news_section layout_padding">
    <form action="<c:url value='/home-new'/>" id="formSubmit" method="get">
        <div class="container">
            ...
            <input type="hidden" value="" id="id_id" name="id"/>
...
<script>
     ...
     document.getElementById("id_id").value = myParam; // gán value myParam cho thẻ input có ID = id_cate
        ...
        window.pagObj = $('#pagination').twbsPagination({
            ...
            onPageClick: function (event, page) {
                if (currentPage != page) {
                    ...
                    $('#id_sortName').val('id');
                    $('#id_sortBy').val('asc');
                    $('#id_type').val('list-by-category-code');
                    $('#formSubmit').submit();
                }
            }
        });
