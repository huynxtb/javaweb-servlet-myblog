            ...
            <div class="row">
                <div class="col-xs-12">
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                ...
                                <c:if test="${empty model.id}">
                                    <input type="button" class="btn btn-white btn-warning btn-bold"
                                           value="Create New" id="btnAddOrUpdateNew"/>
                                </c:if>
                    ...
                    <div class="text-center">
                        <a class="blue bolder"
                           href='<c:url value="/admin-category?type=list&page=1&maxPageItem=4&sortName=id&sortBy=asc"/>'>Back
                            To News List</a>
                    </div>
    ...
    function addNew(data) {
        $.ajax({
            ...
            error: function (error) {
                window.location.href = "${CategoryURL}?type=list&maxPageItem=4&page=1&message=error_system";
            }
        });
    }
